<?php
	...
	class ClientManager {
		...
		public function add(Client $client) {
			$new_client = $this->bdd->prepare('INSERT INTO client(Nom_client, Prenom_client, n_tel, Mail) VALUES (:Nom, :Prenom, :Tel, :Mail)');
		...
		public function update(Client $client, $id) {
			$req = $this->bdd->prepare('UPDATE client SET Nom_client = :nom, Prenom_client = :prenom, n_tel = :tel WHERE ID_client = :id');
